import { cart, removeFromCart, calculateCartQuantity, updateQuantity, updatedDeliveryOption} from "../../data/cart.js";
...
export function renderOrderSummary() {
  ...
  document.querySelector('.js-order-summary').innerHTML = chartSummaryHTML;
